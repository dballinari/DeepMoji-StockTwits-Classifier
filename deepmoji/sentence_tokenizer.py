...
class SentenceTokenizer():
    ...
    def split_train_val_test(self, sentences, info_dicts,
        ...
        # If passed three lists (each list contains the index of respectively train, validation and test indices),
        # use those directly
        ...
        # Wrap results: returns a list of three matrix where each raw represents a sentence and each column a word. The
        # matrix is filled with the index connecting each word to a word in the vocabulary
    ...
    def get_test_sentences(self, sentences):
        """
        ...
        """
        result = self.tokenize_sentences(sentences)[0]
